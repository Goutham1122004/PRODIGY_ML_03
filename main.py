...
cats_train_folder = "dataset/training_set/cats"  # Replace with the path to your cat training set folder
cat_images = []
...
dogs_train_folder = "dataset/training_set/dogs"  # Replace with the path to your dog training set folder
dog_images = []
...
sample_image_path = "dataset/test_set/dogs/dog.4002.jpg" 
